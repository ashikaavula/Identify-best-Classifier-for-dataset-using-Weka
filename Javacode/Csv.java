...
// csv is main file. CSV file has each painting links which is specified in string location as path
public class Csv {
	public static void main(String[] args) {
		try{
            ...
            while ((line = reader.readNext()) != null) {
            	count++;
                //painting object has setters and getters. here we are setting the attributes.
